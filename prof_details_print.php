...
<head>
    ...
    <title>PROFESSOR DETAIL UPDATE</title>
                    ...
                    <div
                        ...
                        <div class="w-100 p-6 p-md-8 card border-0  text-light"
                            ...
                            <form class="row g-1 p-4 p-md-4" action="" method="POST">
                                ...
                                <h1 class="col-12 text-center mb-1 mb-lg">Professor Details Print</h1>
                                <?php
                                if (session_status() == PHP_SESSION_NONE) {
                                    session_start();
                                }
                                ...
                                <div class="col-12">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control form-control-lg" placeholder="John"
                                            name="prof_name" value="<?php echo $_SESSION['prof_fullname'];  ?>"
                                            disabled>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control form-control-lg" maxlength="10"
                                            ...
                                            value="<?php echo $_SESSION['prof_id'];  ?>" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="prof_dob"
                                            value="<?php echo  $_SESSION['prof_dob']; ?>" disabled>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="mb-2">
                                        <label class="form-label">Address</label>
                                        <input type="text" class="form-control form-control-lg" name="prof_address"
                                            value="<?php echo $_SESSION['prof_address'];  ?>" disabled>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control form-control-lg" maxlength="10"
                                            oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                            value="<?php echo $_SESSION['prof_phone'];  ?>" disabled>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control form-control-lg" maxlength="10"
                                            ...
                                            value="<?php echo  $_SESSION['prof_nic'];  ?>" disabled>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control form-control-lg" maxlength="10"
                                            ...
                                            value="<?php echo   $_SESSION['prof_status'];  ?>" disabled>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="mb-2">
                                        <label class="form-label">Your Time</label>
                                        <input type="text" class="form-control form-control-lg" maxlength="10"
                                           
                                            value="<?php echo   $_SESSION['prof_type'];  ?>" disabled>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control form-control-lg" maxlength="10"
                                            ...
                                            value="<?php echo   $_SESSION['teach_degree'];  ?>" disabled>
                                    </div>
                                </div>
