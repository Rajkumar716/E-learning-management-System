...
<head>
    ...
    <title>ADMIN::VIEW PROFESSORS DETAILS</title>
                            ...
                            <div class="card mb-3">
                                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                                    <div class="info-header">
                                        <h6 class="mb-0 fw-bold ">All Professors Information</h6>
                                    </div>
                                    ...
                                    <table id="myProjectTable" class="table table-hover align-middle mb-0" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_POST['search_btn'])) {
                                                $search_query = "SELECT * FROM `professor_registration` WHERE prof_id like('$_POST[search_input]%') OR prof_fullname like('$_POST[search_input]%') ";
                                                ...
                                                while ($row = mysqli_fetch_assoc($search_result)) {
                                                    ...
                                                    echo "<td>{$row['prof_address']}</td>";
                                                    echo "<td>{$row['prof_phone']}</td>";
                                                    echo "<td>{$row['prof_dob']}</td>";
                                                    echo "<td>{$row['prof_nic']}</td>";
                                                    echo "<td>{$row['prof_type']}</td>";
                                                    echo "<td>{$row['prof_status']}</td>";

                                                    echo "<form action='admin_prof_update.php' method='post'>";
                                                    echo "<input type='hidden' value='{$row['prof_id']}' name='prof_id'>";

                                                    if ($row['prof_status'] == 'Activate') {
                                                    ...
                                                    echo "</form>";
                                                    echo "<form action='admin_prof_deails_update.php' method='post'>";
                                                    echo "<input type='hidden' value='{$row['prof_id']}' name='prof_id'>";


                                                    echo "<td><button type='submit' class='btn btn-success' name='update_prof' value='update'>UPDATE</button></td>";
