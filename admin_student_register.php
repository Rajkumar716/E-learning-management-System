                    ...
                    <div class="row g-3 mb-3 row-deck">
                        ...
                        <div class="col-md-9 col-lg-9 col-xl-9 col-xxl-9">
                            <div class="alert alert-primary p-3 mb-0 w-100">
                                <form class="row g-1 p-4 p-md-4" action="admin_student_reg_submit.php" method="POST"
                                    id="myform">
                                    ...
                                    <div class="col-6">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" class="form-control form-control-lg" placeholder="John"
                                                name="student_name" id="student_name" required>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-2">
                                            ...
                                            <input type="email" class="form-control form-control-lg"
                                                placeholder="Parker@gmail.com" name="student_email" id="student_email"
                                                required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" class="form-control form-control-lg"
                                                placeholder="MM/DD/YYYY" name="student_dob" required>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" class="form-control form-control-lg"
                                                placeholder="address" name="student_address" required>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" class="form-control form-control-lg"
                                                placeholder="phone number" name="student_number" maxlength="10"
                                    ...
                                    <div class="col-6">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" class="form-control form-control-lg"
                                                placeholder="nic number" name="student_nic" required>
                                        </div>
                                    </div>
