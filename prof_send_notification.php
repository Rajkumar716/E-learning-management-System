...
$teach_course=$row['teach_degree'];
$_SESSION['teach_degree']=$teach_course;
}
$result=0;
...
<head>
    ...
    <title>PROFESSOR SEND NOTIFICATION</title>
                ...
                <div class="container-xxl">
                    ...
                    <div class="card mb-3">
                        <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                            <h6 class="mb-0 fw-bold ">Professor Send Notification</h6>
                            <?php
                                         if(session_status()==PHP_SESSION_NONE){
                                         session_start();
                                         }
                        ...
                        <div class="card-body">
                            <form id="basic-form" action="prof_notification_submit.php" method="post">
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-12">
                                    <select name="reciever_id" class="form-control form-control-lg ">
                                            <option value="hidden">-----Select Student Course ID-----</option>
                                            <?php
                                            $res = mysqli_query($connection, "select course_id  from course where course_name='$_SESSION[teach_degree]'");
                                            while ($row = mysqli_fetch_array($res)) {
