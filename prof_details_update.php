                ...
                <div class="container-xxl">
                    ...
                    <div class="col-lg-12 d-flex justify-content-center align-items-center border-0 rounded-lg auth-h100">
                        <div class="w-100 p-6 p-md-8 card border-0  text-light" style="max-width: 32rem;background-color:rgb(148, 77, 255)">
                            ...
                            <form class="row g-1 p-4 p-md-4" action="prof_details_update_submit.php" method="POST">
                                ...
                                <div class="col-12">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="prof_dob" value="<?php echo  $_SESSION['prof_dob']; ?>" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="mb-2">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control form-control-lg" maxlength="10"
                                         oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                          name="prof_number" value="<?php echo $_SESSION['prof_phone'];  ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 text-center mt-4">
                                    <a href="prof_view_details.php" class="btn btn-lg btn-block btn-light lift text-uppercase"><span>&#10237;</span>
                                        BACK</a>
                                </div>
