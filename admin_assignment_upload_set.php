...
<head>
    ...
    <title>ADMIN::STUDENT ASSIGNEMENT UPLOAD SET</title>
                    ...
                    <div class="row g-3 mb-3 row-deck">
                        ...
                        <div class="col-md-9 col-lg-9 col-xl-9 col-xxl-9">
                            <div class="alert alert-primary p-3 mb-0 w-100">
                                <form class="row g-1 p-4 p-md-4" action="admin_assignment_upload_submit.php"
                                    method="POST" id="myform">
                                    <div class="col-12 text-center mb-1 mb-lg-5">
                                        <h1>Student Upload Set</h1>
                                    ...
                                    $select_batch="SELECT * FROM `batch_details` WHERE batch_status='Activate'";
                                    $batch_result=mysqli_query($connection,$select_batch);
                                    while($row_batch=mysqli_fetch_assoc($batch_result)){
                                        $batch_year=$row_batch['batch_start_year'];
                                        $_SESSION['batch_start_year']=$batch_year;

                                        $batch_number=$row_batch['batch_number'];
                                        $_SESSION['batch_number']=$batch_number;

                                        $batch_course_name=$row_batch['course_name'];
                                        $_SESSION['course_name']=$batch_course_name;
                                    }
                                    ...
                                    <div class="col-6">
                                        <div class="mb-2">
                                            <label class="form-label">Subjet ID</label>
                                    ...
                                    <div class="col-6">
                                        <div class="mb-2">
                                            <label class="form-label">Choose Course Year</label>
                                            <select name="course_year" id="cars" class="form-control form-control-lg ">
                                                <option value="" selected disabled>-----Select Year-----</option>
                                                <?php
                                                      

                                                      echo "<option value='$batch_year'>";
                                                          echo $batch_year;
                                                     echo "</option>";
                                    ...
                                    <div class="col-6">
                                        <div class="mb-2">
                                            ...
                                            <select name="course_batch" id="cars" class="form-control form-control-lg ">
                                                <option value="" selected disabled>-----Select Batch Number-----
                                                </option>
                                                <?php
                                                      

                                                              echo "<option value='$batch_number'>";
                                                                  echo $batch_number;
                                                             echo "</option>";
                                    ...
                                    <div class="col-6">
                                        <div class="mb-2">
                                            <label class="form-label">Choose Subject Name</label>
                                    ...
                                    <div class="col-6">
                                        <div class="mb-2">
                                            <label class="form-label">Choose Course Name</label>

                                            <select name="course_name" class="form-control form-control-lg " required>
                                                <option value="" selected disabled>-----Select Course-----</option>
                                                <?php
                                            $res = mysqli_query($connection, "SELECT * FROM `batch_details` WHERE batch_status='Activate'");
                                            while ($row = mysqli_fetch_array($res)) {
                                    ...
                                    <div class="col-6">
                                        <div class="mb-2">
                                            ...
                                            <input type="date" class="form-control form-control-lg" name="deadline_date"
                                                id="deadline_date" placeholder="eg:2022-06-26" required>
                                        </div>
                                    </div>
