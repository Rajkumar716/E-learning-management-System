...
<head>
    ...
    <title>STUDENT RE-UPLOAD ASSIGNMENT</title>
                    ...
                    <div class="row g-0">
                        ...
                        <div
                            ...
                            <div class="w-100 p-3 p-md-5 card border-0  text-light"
                                ...
                                ?>
                                <!-- Form -->
                                <form class="row g-1 p-4 p-md-4" action="student_upload_assignment_re_submit.php"
                                    method="POST" id="myform" enctype="multipart/form-data">

                                    <h1 class="col-12 text-center ">RE-SUBMIT ASSIGNMENT</h1>
                                    ...
                                    <div>
                                    <a href="student_view_upload_assignment.php"
