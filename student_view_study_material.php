...
<head>
    ...
    <title>STUDENT VIEW STUDY MATERIAL</title>
                                        ...
                                        <tbody>
                                            <?php
                                              if(isset($_POST['search_btn'])){
                                                $search_sql="SELECT * FROM study_material WHERE material_name LIKE('$_POST[search_input]%') OR subject_id like('$_POST[search_input]%') OR materail_id like('$_POST[search_input]%')";
                                               ...
                                               echo "<form action='student_material_download.php' method='post'>";
