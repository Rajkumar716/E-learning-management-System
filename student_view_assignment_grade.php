...
$result=$private_result+$public_result;
                            ...
                            <div class="card mb-3">
                                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                                    <div class="info-header">
                                        <h6 class="mb-0 fw-bold ">Student View Assignment Grades</h6>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="myProjectTable" class="table table-hover align-middle mb-0"
                                        ...
                                        <tbody>
                                            <?php
                                            error_reporting(0);
                                               $query="SELECT * FROM `course_subject_assignments` WHERE student_course_id='$course_id'";
