...
<head>
    ...
    <title>STUDENT VIEW UPLOAD ASSIGNMENT</title>
                            ...
                            <div class="card mb-3">
                                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                                    <div class="info-header">
                                        <h6 class="mb-0 fw-bold ">Admin View Set Assignment </h6>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="myProjectTable" class="table table-hover align-middle mb-0" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                            error_reporting(0);
                                            $query = "SELECT * FROM `course_assignment_set`";
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo "<form action='admin_update_assignment_deadline.php' method='post'>";
                                                    echo "<input type='hidden' value='{$row['id']}' name='id'>";
    
                                                   
                                                        echo "<td><button type='submit' class='btn btn-success'>Update Date</button></td>";
