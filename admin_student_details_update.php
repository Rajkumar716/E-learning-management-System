...
while($row=mysqli_fetch_assoc($query_result)){
    ...
    $_SESSION['student_phonenumber']=$student_phonenumber;

    $student_dob=$row['student_dob'];
    $_SESSION['student_dob']=$student_dob;

    $student_nic=$row['student_nic'];
    $_SESSION['student_nic']=$student_nic;
}
                ...
                <div class="container-xxl">
                    ...
                    <div class="col-lg-12 d-flex justify-content-center align-items-center border-0 rounded-lg auth-h100">
                        <div class="w-100 p-6 p-md-8 card border-0  text-light" style="max-width: 32rem;background-color:rgb(148, 77, 255)">
                            <!-- Form -->
                            <form class="row g-1 p-4 p-md-4" action="admin_student_details_update_submit.php" method="POST">
                                ...
                                <div class="col-6">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control form-control-lg" placeholder="John" name="student_email" value="<?php echo $_SESSION['student_email'];  ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="mb-2">
                                        ...
                                        value="<?php echo $_SESSION['student_phonenumber'];  ?>"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" maxlength="10"
                                           required>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="mb-2">
                                        <label class="form-label">Student Nic</label>
                                        <input type="text" class="form-control form-control-lg" name="student_nic" 
                                        value="<?php echo $_SESSION['student_nic'];  ?>"   maxlength="10"
                                           required>
                                    </div>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12 text-left mt-4">
                                    <a href="admin_view_student_details.php" class="btn btn-lg btn-block btn-light lift text-uppercase"><span>&#10237;</span>
                                        BACK</a>
                                </div>
