...
<head>
    ...
    <title>ADMIN::VIEW ALL COURSE DETAILS</title>
                                    ...
                                    <table id="myProjectTable" class="table table-hover align-middle mb-0"
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_POST['search_btn'])) {
                                                $search_query = "SELECT * FROM `course` WHERE student_id like('$_POST[search_input]%') OR course_id like('$_POST[search_input]%') ";
                                                ...
                                                while ($row = mysqli_fetch_assoc($search_result)) {
                                                    ...
                                                    echo "<form action='admin_student_course_update.php' method='post'>";
                                                    echo "<input type='hidden' value='{$row['course_id']}' name='course_id'>";

                                                    if ($row['course_status'] == 'Activate') {
                                                    ...
                                                    echo "</form>";
                                                    echo "<form action='admin_student_course_delete.php' method='post'>";
                                                    echo "<input type='hidden' value='{$row['course_id']}' name='course_id'>";


                                                    echo "<td><button type='submit' class='btn btn-danger' name='course_delete' value='delete'>DELETE</button></td>";
