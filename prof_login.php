                    ...
                    <div class="row g-0">
                        <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center rounded-lg auth-h100">
                            <div style="max-width: 25rem;">
                                ...
                                <div class="mb-5">
                                    <h2 class="color-900 text-center">PROFESSOR LOGIN HERE</h2>
                                </div>
                                <!-- Image block -->
                                <div class="">
                        ...
                        <div class="col-lg-6 d-flex justify-content-center align-items-center border-0 rounded-lg auth-h100">
                            <div class="w-100 p-3 p-md-5 card border-0  text-light" style="max-width: 32rem;background-color:rgb(148, 77, 255)">
                                <!-- Form -->
                                <form class="row g-1 p-3 p-md-4" method="POST" action="prof_login_submit.php">
                                    <div class="col-12 text-center mb-1 mb-lg-5">
                                        <h1>LOG IN</h1>
                                        <span>Professor access to our dashboard.</span>
                                    </div>
                                    <?php
                                    // echo session_status();
                                    ...
                                    <div class="col-12">
                                        <div class="mb-2">
                                            ...
                                            <input type="email" class="form-control form-control-lg" placeholder="name@example.com" name="prof_email">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-2">
                                            <div class="form-label">
                                                <span class="d-flex justify-content-between align-items-center">
                                                    Password
                                                    <a class="text-secondary" href="prof_forget_password.php">Forgot
                                                        Password?</a>
                                                </span>
                                            </div>
                                            <input type="password" class="form-control form-control-lg" placeholder="***************" name="prof_password">
                                        </div>
                                    </div>
