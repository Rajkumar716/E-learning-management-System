                    ...
                    <div class="row g-3 mb-3 row-deck">
                        <div class="col-md-9 col-lg-9 col-xl-9 col-xxl-9" style="background-color:rgb(191, 0, 255) ;">
                            <div class="alert alert-primary p-3 mb-0 w-100">
                                ...
                                <form class="row g-1 p-4 p-md-4" action="prof_password_change_submit.php" method="POST"
                                    id="myform">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" class="form-control form-control-lg" name="prof_id"
                                                id="prof_id" placeholder="Enter the Id" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" class="form-control form-control-lg"
                                                ...
                                                id="course_old_password" minlength="6" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-2">
