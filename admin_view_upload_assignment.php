                            ...
                            <div class="card mb-3">
                                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                                    <div class="info-header">
                                        <h6 class="mb-0 fw-bold ">Admin Upload Assignment View</h6>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="myProjectTable" class="table table-hover align-middle mb-0" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                            error_reporting(0);
                                            $query = "SELECT * FROM `course_subject_assignments`";
                                            $result = mysqli_query($connection, $query);

                                            while ($row = mysqli_fetch_assoc($result)) {
                                                $status = "Pending";
                                                if (date($row['deadline_date']) > date($row['submit_date'])) {
                                                    $status = 'On Submit';
                                                } elseif (date($$row['deadline_date']) < date($row['submit_date'])) {
                                                    $status = 'Late Submit';
                                                }
