...
<head>
    ...
    <title>::STUDENT-Task::STUDENT CHAT</title>
...
<body>
    <div class="container">
        <h2 class="text-center" style="margin-top: 5px; padding-top: 0;">STUDENT CHAT ROOM</h2>
        <hr>
        <div class="row">
            <div class="col-md-4">
                <?php 
                                ...
                                <tr>
								 ...
								 ?>
                                    ...
                                    <td align="right" colspan="2">
                                        <form action="student_leave_chat.php" method="POST">
