...
<head>
    ...
    <title>PROFESSOR::VIEW STUDY MATERIALS</title>
                                    ...
                                    <table id="myProjectTable" class="table table-hover align-middle mb-0"
                                        ...
                                        <tbody>
                                            ...
                                            if(isset($_POST['search_btn'])){
                                                $search_sql="SELECT * FROM study_material WHERE material_name LIKE('$_POST[search_input]%') OR materail_id like('$_POST[search_input]%') OR subject_id like('$_POST[search_input]%')";
                                               ...
                                               echo "<form action='prof_material_download.php' method='post'>";
