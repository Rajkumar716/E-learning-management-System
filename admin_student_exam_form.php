...
<head>
    ...
    <title>ADMIN::VIEW STUDENT EXAM FORM DETAILS</title>
                            ...
                            <div class="card mb-3">
                                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                                    <div class="info-header">
                                        <h6 class="mb-0 fw-bold ">All Student Exam Registration Information</h6>
                                        <?php
                                        if (isset($_GET['msg'])) {
                                ...
                                <div class="card-body">
                                    <table id="myProjectTable" class="table table-hover align-middle mb-0" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $query = "SELECT * FROM `exam_registration` ";
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo "<form action='admin_student_exam_update.php' method='post'>";
                                                echo "<input type='hidden' value='{$row['reg_id']}' name='reg_id'>";


                                                echo "<td><button type='submit' class='btn btn-success' value='De-Activate' name='set_status'>APPROVE</button></td>";
