...
<head>
    ...
    <title>PROFESSOR VIEW SEND NOTIFICATION</title>
                ...
                <div class="container-xxl">
                    ...
                    <div class="card mb-3">
                        <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                            <h6 class="mb-0 fw-bold ">Professor View Send Notification</h6>
                            <?php
                                         if(session_status()==PHP_SESSION_NONE){
                                         session_start();
                                         }
                        ...
                        <?php
                             $sql="SELECT * FROM `notification` where sender_id='$profid' ";
                             ...
                             while($row=mysqli_fetch_assoc($RESULT)){
                                ...
                                echo '<form action="prof_send_notification_delete.php" method="POST">';
                                echo "<input type='hidden' value='{$row['notification_id']}' name='notification_id'>";
                                echo "<button type='submit' class='btn btn-danger btn1' value='delete' name='delete'>DELETE</button>";
                                echo '</form>'; 
                                echo '</div>';
                                echo '</div>';
                                echo '</div>';
