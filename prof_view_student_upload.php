...
$course_name=$row['teach_degree'];
$_SESSION['teach_degree']=$course_name;
...
<head>
    ...
    <title>PROFESSOR VIEW UPLOAD ASSIGNMENT</title>
                            ...
                            <div class="card mb-3">
                                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                                    <div class="info-header">
                                        <h6 class="mb-0 fw-bold ">Student Assignment Uploads</h6>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="myProjectTable" class="table table-hover align-middle mb-0"
                                        ...
                                        <tbody>
                                            <?php
                                            error_reporting(0);
                                               $query="SELECT * FROM `course_subject_assignments` WHERE  course_name='$_SESSION[teach_degree]'";
                                               ...
                                               echo "<form action='prof_uploaded_download.php' method='post'>";
                                               ...
                                               echo "</form>";
                                               echo "<form action='prof_assignment_grade.php' method='post'>";
                                               echo "<input type='hidden' value='{$row['id']}' name='id'>";
                                               
                                           
                                                   echo "<td><button type='submit' class='btn btn-success' value='download' name='download'>GRADE</button></td>";
