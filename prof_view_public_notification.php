...
mysqli_query($connection,"update notification set read_status='Yes' where reciever_status='professor' and reciever_id='0'");
...
<head>
    ...
    <title>PROFESSOR VIEW PUBLIC NOTIFICATION</title>
                                    ...
                                    <div class="card border-0 w380">
                                        <div class="card-header border-0 p-3">
                                            <h5 class="mb-0 font-weight-light d-flex justify-content-between">
                                                <span>Recieved Notifications</span>
                ...
                <div class="container-xxl">
                    ...
                    <div class="card mb-3">
                        <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                            <h6 class="mb-0 fw-bold ">Professor View Recievered Notification</h6>
                            <?php
                                         if(session_status()==PHP_SESSION_NONE){
                                         session_start();
                                         }
                        ...
                        <?php
                             $sql="SELECT * FROM `notification` where reciever_id='0' and reciever_status='professor' ";
