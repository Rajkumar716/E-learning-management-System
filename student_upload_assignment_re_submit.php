...
if(isset($_POST['upload'])){
    ...
    if($file_size>31457280){
        ...
        header("location:student_assignment_re_upload.php?error=file size is too large");
         }else{
            ...
            if(mysqli_affected_rows($connection)==1){
                ...
                if(mysqli_affected_rows($connection)==1){
                    ...
                    header('location:student_view_upload_assignment.php?msg=Assignment  Re-Submit Successfully...');
                }
                elseif(mysqli_affected_rows($connection)==0){
                    header('location:student_assignment_re_upload.php?msg=Assignment Re-Submit Failed...');
               ...
               if($result==1){
                ...
                header('location:student_assignment_re_upload.php?error=Assignment Re-Submit Failed...');
