...
mysqli_query($connection,"update notification set read_status='Yes' where reciever_status='professor' and reciever_id='$profid'");
...
<head>
    ...
    <title>PROFESSOR VIEW PRIVATE NOTIFICATION</title>
            ...
            <div class="body d-flex py-3">
                <div class="container-xxl">
                    ...
                    <div class="card mb-3">
                        ...
                        <?php
                             $sql="SELECT * FROM `notification` where reciever_id='$profid' ";
