...
<head>
    ...
    <title>STUDENT VIEW COURSE DETAILS</title>
                            ...
                            <div class="card mb-3">
                                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                                    <div class="info-header">
                                        <h6 class="mb-0 fw-bold ">Student Course Information</h6>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <table id="myProjectTable" class="table table-hover align-middle mb-0"
                                        ...
                                        <tbody>
                                            <?php
                                               $query="SELECT * FROM `course` WHERE curse_login_username='$_SESSION[coursegmail]' AND course_id='$_SESSION[course_id]'";
                                               ...
                                               while($row=mysqli_fetch_assoc($result)){
                                                ...
                                                $coursestartyear=$row['course_started_year'];
                                                $_SESSION['course_started_year']=$coursestartyear;
                                                $coursebatch=$row['course_batch'];
                                                $_SESSION['course_batch']=$coursebatch;
                                                $courseduration=$row['course_duration'];
                                                $_SESSION['course_duration']=$courseduration;
                                                $studentemail=$row['student_email'];
                                                $_SESSION['student_email']=$studentemail;
                                                $coursecost=$row['course_cost'];
                                                $_SESSION['course_cost']=$coursecost;
                                                $coursestatus=$row['course_status'];
                                                $_SESSION['course_status']=$coursestatus;
                                                $coursestartdate=$row['course_start_date'];
                                                $_SESSION['course_start_date']=$coursestartdate;
                                               echo "<tr>";
                                               echo "<td>{$row['course_id']}</td>";
                                               echo "<td>{$row['course_name']}</td>";
                                               echo "<td>{$row['course_started_year']}</td>";
                                               ...
                                               echo "<td><a type='button' class='btn btn-primary' href='student_course_details_print.php'>PRINT</a></td>";
                                               echo "</tr>";
