                    ...
                    <div class="row g-0">
                        ...
                        <div
                            ...
                            <div class="w-100 p-3 p-md-5 card border-0  text-light"
                                ...
                                <!-- Form -->
                                <form class="row g-1 p-4 p-md-4" action="student_forget_password_submit.php"
                                    method="POST">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-2">
                                            <label class="form-label">COURSE USER  ID</label>
                                            <input type="text" class="form-control form-control-lg"
                                                name="course_userid"   oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>
                                        </div>
                                    </div>

                                    <div class="col-12">
                                        <div class="mb-2">
                                            <label class="form-label">COURSE USER NAME</label>
                                            <input type="email" class="form-control form-control-lg"
                                                name="course_username" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-2">
                                            ...
                                            <input type="password" class="form-control form-control-lg"
                                                placeholder="6+ characters" name="new_password" minlength="6" required>
                                        </div>
                                    </div>
