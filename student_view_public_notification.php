...
mysqli_query($connection,"update notification set read_status='Yes' where reciever_status='student' and reciever_id='0'");
            ...
            <div class="body d-flex py-3">
                <div class="container-xxl">
                    ...
                    <div class="card mb-3">
                        ...
                        <?php
                             $sql="SELECT * FROM `notification` WHERE reciever_id='0' and reciever_status='student'";
